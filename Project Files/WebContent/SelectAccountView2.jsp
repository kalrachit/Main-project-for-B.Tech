<%@ taglib prefix="sql" uri="http://java.sun.com/jsp/jstl/sql" %> <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
...
<c:if test="${param.type !='Student'}">
	<!-- header -->
	<%String str="ViewUsers.jsp?type="+request.getParameter("type");
		...
		<div class="main">
			...
			<div>
				<div class="padding" align="center">
						...
						<form method="post" action="ViewUsers.jsp" name="delete1" >
								...
								<div class="padding" align="center">
									<div class="wrapper margin-bot">
										...
										<table class="tablemod" style="width: 700px;align:center;margin-top:50px" border="0">
											<tr>
												<td align="center" colspan="4"><h2 style="color:black;margin-left:40px">Select Year</h2></td>
																						
											</tr>
											
											<tr>
												<td colspan="4" align="Center"><select name="year">
