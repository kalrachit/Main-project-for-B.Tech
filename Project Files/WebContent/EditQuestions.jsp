...
<script type="text/javascript">
	...
	function validate() {
		...
		if (document.delete1.level.value == "-1") {
			alert("Please Select a level");
			document.delete1.level.focus();
			return false;
		}
	}
</script>
			...
			<div class="contentadmin"
				...
				<div>
					<div class="padding" align="center">
						...
						<form method="post" action="EditQuestions2.jsp" name="delete1">
									...
									<table class="tablemod" style="width: 700px; align: center">
										<tr>
											<td align="center" colspan="4"><h2
													style="color: black; margin-left: 150px">Edit Question</h2></td>
										...
										<td><input type="submit" value="Edit" name="button"
