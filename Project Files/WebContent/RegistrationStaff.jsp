			...
			<header>
				...
				<div class="row-3">
					<div class="padding" align="center">
						...
						<form method="post" action="RegistrationStaff2.jsp" name="add">
										...
										<table class="tablemod1"
											...
											<tr>
												<td align="center" colspan="4"><h2
														style="color: white; margin-left: 140px">Staff
														Registration</h2></td>
											</tr>
											<tr>
											...
											<tr>
												<td align="right" style="color: Black">Status</td>
												<td colspan="2" align="center" style="color: Black">Teaching
													<input type="radio" name="status" value="Teacher" />
													NonTeaching <input type="radio" name="status"
													style="color: Black" value="Steno" />
												</td>
											</tr>
											<tr>
												<td align="right" style="color: Black">Qualification</td>
												<td colspan="2" align="center"><input type="text"
